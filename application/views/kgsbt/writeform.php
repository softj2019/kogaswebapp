...
<div class="content">
	<div class="container-fluid">
		...
		<div class="hiddenReqPhour" data-id="kgsbt">
					...
					<div class="card-body scroll-300">
						...
						<div class="form-group row">
							...
							<div class="col-2">
								...
								<button type="button" class="btn btn-success btn-block submitKgArt" data-id="kgsbt">분석 실행</button>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLabel">
					신뢰도 분석결과
					<span id="test" class="mt-1 float-right">운전시간 비율(0~1) : <span id="ohourText"></span>   </span>
				</h4>
